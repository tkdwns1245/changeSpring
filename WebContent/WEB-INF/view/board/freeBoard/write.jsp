...
<body>
	...
	<div class="container" id="content">
		...
		<div class="row">
			...
			<form:form class="col-lg-8" method="post" name="writeForm" action="write"
			...
			<table class="table table-striped table-bordered">
				...
				<tr>
					<td class="attr">내용</td>
					<td>
					<textarea class="form-control" name="content" rows="27" cols="40"></textarea>
					</td>
				</tr>
				<tr>
					<form:hidden path="id" value="${authInfo.id}"/>
				</tr>
				<tr>
					<td colspan="2" class="attr">
						...
						<input class="btn btn-primary" type="button" value="목록"
								onClick="javascript:window.location='${pageContext.request.contextPath}/board'">
					</td>
				</tr>
			</table>
			</form:form>
