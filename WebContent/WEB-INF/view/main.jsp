	...
	<div class="container" id="content">
		<c:choose >
			...
			<div class="col-sm-3 col-sm-offset-1 blog-sidebar">
				<div class="jumbotron">
					<form:form action="login" method="post" commandName="loginCommand">
          ...
          <div id="myCarousel" class="carousel slide" data-ride="carousel">
          	...
          	<div class="carousel-inner">
          		<div class="item active">
          			...
          			<img src="${pageContext.request.contextPath}/Resource/img/love.jpg" alt="love">
          			</a>
          		...
          		<div class="item">
          			<a href="board.jsp">
          			<img src="${pageContext.request.contextPath}/Resource/img/board.jpg" alt="board">
          			</a>
          			<div class="carousel-caption">
          				<h3>게시판이 개설되었어요!</h3>
          			</div>
          		...
          		<div class="item">
          			<img src="${pageContext.request.contextPath}/Resource/img/spring.jpg" alt="spring">
          			<div class="carousel-caption">
          				<h3>여름이 오고 있어요</h3>
          			</div>
          		</div>
